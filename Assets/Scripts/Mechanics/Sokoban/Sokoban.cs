...
public class Sokoban : MonoBehaviour {
    ...
    private SokobanBlock oneCol;
    private SokobanBlock twoCol;
    ...
    void Update() {
        ...
        switch (state) {
            case SokobanFSM.LOADING:
                gameObject.GetComponent<LoadSokoban>().loadLevel();
                if (gameObject.GetComponent<LoadSokoban>().getLevel() > 1) {
                ...
                if (Input.GetButtonDown(CONFIRM)) {
                    ...
                    if (Physics.Raycast(ray, out RaycastHit hit, 100, layerMask)) {
                        ...
                        if (hit.collider != null && hit.collider.tag != "back") {
                            ...
                            oneCol = currentBlock.transform.GetChild(0).GetComponent<SokobanBlock>();
                            twoCol = currentBlock.transform.GetChild(1).GetComponent<SokobanBlock>();
    ...
    public void sokobanWin() {
        ...
        winCartel.transform.GetChild(1).GetComponent<TMP_Text>().text = "" + nMovements +"/"+nmaxMovs[gameObject.GetComponent<LoadSokoban>().getLevel() - 1];
        winEffect.Play();
