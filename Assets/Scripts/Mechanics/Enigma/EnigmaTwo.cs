...
public class EnigmaTwo : MonoBehaviour {
    ...
    private bool[] checkCode() {
        for (int i = 0; i < numeroRuedas; i++) {
            solucionPropuesta[i] = rueda[i].transform.GetChild(1).GetComponent<NotchEnigma>().getTargetName();
        }
